...
$sql = "INSERT INTO pengurus (nim, nama, fakultas, jabatan) 
VALUES('$nim', '$nama', '$fakultas', '$jabatan')";
...
$sql = "UPDATE pengurus SET nim='$nim', nama='$nama', 
fakultas='$fakultas', jabatan='$jabatan' where nim = '$nim'";
$query = $this->db->query($sql);
if(!$query){
return "Failed";
}
