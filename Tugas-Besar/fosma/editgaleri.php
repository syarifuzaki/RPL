		  ...
		  <div class="col-md-10">
              ...
              <div class="panel-body">
                ...
                <?php
              	include "koneksi.php";
              	$id = $_GET['id'];
                $query = "SELECT * FROM galeri WHERE id='$id'"; // Tampilkan semua data gambar
                ...
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      <input class="form-control" placeholder="Galeri" type="text" name="deskripsi" value="<?php echo $data['deskripsi'] ?>">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-md-2 control-label">Input Gambar</label>
                    <div class="col-md-10">
                      <input type="file" class="btn btn-default" id="exampleInputFile1" name="galeri" value="<?php echo $data['galeri'] ?>">
                      <p class="help-block">
